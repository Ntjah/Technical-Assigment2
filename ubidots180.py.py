...
TOKEN = "BBFF-4PzhTSkXHQcCmIoWjgiCtfFaI1vQ9h"  # Put your TOKEN here
DEVICE_LABEL = "fafe-180"  # Put your device label here
...
if __name__ == '__main__':
    # Add Switch ID
    switch = api.get_variable('64ede740ff9abc000bcb9dc1')
    # Add Slider ID
    slider = api.get_variable('64ede74750785d000c783fee')
    while (True):
        try:
            print("[INFO] ---------------- ")
            main()
